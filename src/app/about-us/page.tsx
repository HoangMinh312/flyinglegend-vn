...
export default function AboutUs() {
  return (
    <>
      ...
      />
      <div className="container mx-auto flex-col gap-6 px-4 py-16">
        <h2 className="my-8 text-4xl font-bold">
          Câu Chuyện Flying Legend Vietnam
        </h2>

        <section className="my-8">
          <h3 className="mb-4 text-2xl font-semibold">Sứ Mệnh</h3>
          <p className="text-lg">
        ...
        <section className="mx-auto my-8 w-full lg:w-3/5">
          <figure>
            <Image
              src={photo2}
        ...
        <section className="my-8">
          <h3 className="mb-4 text-2xl font-semibold">Tầm Nhìn</h3>
          <p className="text-lg">
