...
const section1 = [
  "/conferenceImages/section1pic1.jpg",
  "/conferenceImages/section1pic2.jpg",
];
const section2 = [
  "/conferenceImages/section2pic1.jpg",
  "/conferenceImages/section2pic2.jpg",
];
const section3 = [
  "/conferenceImages/section3pic1.jpg",
  "/conferenceImages/section3pic2.jpg",
];
const section4 = [
  "/conferenceImages/section4pic1.jpg",
  "/conferenceImages/section4pic2.jpg",
  "/conferenceImages/section4pic3.jpg",
  "/conferenceImages/section4pic4.jpg",
];
...
export default function ConferenceMarch2025() {
  return (
    <article className="prose prose-lg mx-auto max-w-5xl px-4 py-12">
      {/* Title */}
      <h1 className="text-3xl">
        <b>HỘI THẢO MÁY BAY TP-150</b>
      </h1>
      {/* Published Date */}
      <p className="mb-2 text-sm text-gray-500">28/03/2025</p>
      {/* Excerpt */}
      <p className="mb-12 italic">
        ...
        việc hiện thực hóa khả năng khai thác dòng máy bay này tại Việt
        Nam.{" "}
      </p>
