...
export default function ConferenceAugust2025() {
  return (
    <article className="prose prose-lg mx-auto max-w-5xl px-4 py-12">
      ...
      {/* Published Date */}
      <p className="mb-2 text-sm text-gray-500">28/08/2025</p>
      {/* Excerpt */}
      <img
        src={heroImage}
        alt="Hội Nghị TP150"
      ...
      <div className="my-4">
        ...
        <p className="text-right text-sm text-gray-500">
          Hai chiếc Tucano-R tại triển lãm &quot;80 năm HÀNH TRÌNH ĐỘC LẬP - TỰ
          DO - HẠNH PHÚC&quot; - Tác giả ảnh: Thành Thơi
        </p>
      </div>
      <h2 className="text-xl">
        <b>
      ...
      <br />
      <h3 className="indent-4 text-lg md:indent-8">
        <b>
