    ...
    <div className="flex flex-col items-center text-center">
      <div className="flex w-1/2 items-center space-x-4">
        <div className="w-full flex-col items-center">
          <h1 className="font-alex-brush flex justify-start text-3xl text-blue-800 md:text-5xl lg:text-6xl">
            Khát vọng vươn mình
          </h1>
          <h1 className="font-alex-brush flex justify-end text-3xl text-blue-800 md:text-5xl lg:text-6xl">
            cùng đất nước
          </h1>
        </div>
        <Image
